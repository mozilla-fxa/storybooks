  ...
  return (
    <Page title="Colors">
      ...
      <p className="pb-6 max-w-4xl">
        ...
        <code className="bg-grey-100 text-sm px-1 rounded-sm">bg</code> for
        background or{' '}
        <code className="bg-grey-100 text-sm px-1 rounded-sm">text</code> for
        text color) with the name of the color and optionally the shade. Some
        examples:
      </p>
